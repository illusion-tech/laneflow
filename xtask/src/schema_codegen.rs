...
pub(crate) const ROAD_EDITING: WireFamily = WireFamily {
    ...
    schema_path: "schemas/road-editing/v2/road-editing.fbs",
...
pub(crate) fn run(family: &WireFamily, args: &[String]) -> Result<(), String> {
    ...
    println!(
        "{} codegen 已通过：{}；Rust canonical bytes clean，C++/C# probe 已生成，generated-only unsafe 边界已闭合",
        family.label,
        flatc.display()
    );
    Ok(())

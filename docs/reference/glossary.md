...
| 当前 JSON               | current JSON                                              | —                                         | Traffic v0.10、SpatialPackage v0.1 与 ScenarioManifest v0.1 的合称；#301 已删除生产 schema 与加载 crate。走廊生成器不再构造这些 JSON；编制走 compiler，制品是 catalog 0.2 与 LFCA。               |

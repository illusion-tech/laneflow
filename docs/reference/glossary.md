...
| 几何精度配置档          | Geometry accuracy profile                                 | `GeometryAccuracyProfile`               | #296 G1 提案中的封闭三档曲线近似配置；同一编译单元一致，调用方显式选择。                                                                                                       |
| 几何方向配置档          | Geometry direction profile                                | `GeometryDirectionProfile`              | #296 G1 提案中的封闭三档折线方向连续性配置；与位置档正交组合、同一编译单元一致，调用方显式选择。                                                                               |

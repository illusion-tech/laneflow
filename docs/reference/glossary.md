...
| P100 首轮编译性能门槛   | P100 initial compiler performance gate                    | `LF-COMP-P100-R0-v1`                    | #292 G1 原输入；G2 发现 #308 抽象工作负载不能无损映射生产语义，现仅作容量估算，尚非产品通过（Product Pass）；整体 G3 前须修订 G1。                                             |

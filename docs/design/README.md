...
- `portable-canonical-artifact.md`：#298 G1 Accepted 设计输入；把上述长期架构收窄为
  ...
  硬上限与 §10 known vectors 已由 G1 冻结；G1 Pass 只授权准备独立 G2 开工判断，在 #298
  正式记录 G2 Pass 前不得启动格式实现或声称已取得执行证据。

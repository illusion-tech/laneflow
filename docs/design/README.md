...
- `portable-canonical-artifact.md`：#298 G1 已重开、内容修正后待重新接受的设计候选；把上述长期架构收窄为
  ...
  硬上限与 §10 known vectors 已闭合；当前仍待新的 exact-head clean review 与正式 G1 判断。
  新 G1 Pass 只授权准备独立 G2 开工判断，在 #298 正式记录 G2 Pass 前不得启动格式实现。

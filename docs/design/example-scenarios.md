...
Traffic v0.7 per-edge 限速的 production schema/Core 基础由 #185 交付；场景人口、回流、generator、Adapter 与 native example 仍由 #186–#189 承担，#195 独立收口。
...
- #185 已通过 G2 并交付 Traffic/Core 限速基础；#186–#189 仍只有分别通过 G2 后才能开始各自 production 实施；

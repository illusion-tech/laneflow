...
| 数值域                                      | 标量                                                 | 权威归属                                 | 规则                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------------- | ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| LFRE wire 几何                              | `f64`（`Vec3F64` + corridor station/宽度标量）       | 私有 wire / schema                       | FlatBuffers `double`（含 `RoadCorridor` `start/end_station_meters`、`LinearWidthProfile` `start/end_width_meters`），format v2 权威；`format_version = 1` 失败关闭；`f32` 量化发生在 geometry compile 边界，不在 wire/lowering 层                                                             |

...
## 14. v0.9 Traffic v0.8 static-domain target

#228/ADR 0017 已接受 #229 的 clean-break target，但 current production 在 #229 G4
前仍是 exact v0.7。本节不得作为 v0.8 loader/schema 已存在的证据。

Target `formatVersion: "0.8"` 原子增加：

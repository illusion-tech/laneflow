...
- 已删除的 current JSON 外部 lane graph / Junction / Movement / ManeuverPath / route / Vehicle Profile / Signals / Parking / 横断面与准入 数据格式、版本、单位（历史）：[`data-format.md`](data-format.md)；

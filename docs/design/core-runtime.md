...
- 当前外部 lane graph / Junction / Movement / ManeuverPath / route / Vehicle Profile / Signals / Parking 数据格式、版本、单位和 schema：[`data-format.md`](data-format.md) 与 [`schemas/laneflow-data-v0.8.schema.json`](../../schemas/laneflow-data-v0.8.schema.json)；

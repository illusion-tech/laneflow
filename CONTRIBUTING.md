...
- `H_pr` 与真实 `H_mg` 都必须完成 `Commit message`、`Rust checks`、`Urban harness tests`、`Dependency policy`、`Analyze (actions)`、`Analyze (rust)`；原生 CodeQL rule 不替代队列中的两个 `Analyze` checks

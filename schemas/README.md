...
| Runtime Snapshot | [`runtime-snapshot/v2/runtime-snapshot.fbs`](runtime-snapshot/v2/runtime-snapshot.fbs) | 生产快照容器；`format_version = 2`       |
...
生产入口。Runtime Snapshot 用 `LFRS` file identifier，现行 `format_version = 2`。

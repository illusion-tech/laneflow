...
| ----------------- | -------------------------------------------------------------------------------------------- | ------------------- |
| Traffic           | [`laneflow-data-v0.10.schema.json`](laneflow-data-v0.10.schema.json)                         | source-only，待发布 |
...
当前 Traffic production source 是 v0.10，尚未进入公共发布集合；v0.9 及更早版本
继续按固定 provenance 永久保留。v0.10 由后续 publication PR 固定 `main`
revision/blob、加入 `publishedSchemas` 并完成 live availability 与 byte-equality
验证。
当前 schema contract 是：

- [`laneflow-data-v0.10.schema.json`](laneflow-data-v0.10.schema.json)（当前 source，待发布）

...
use issue_308_compiler_budget_calibration_research::{
    attribution_binary_descriptor, load_repository_contract, measure_identity_attribution_child,
    wait_for_parent_start_signal,
};

const USAGE: &str = "用法：issue-308-compiler-budget-calibration-attribution <describe-role|run>\n  run <compiler-instance-id> <graph-profile> <N> <controlled-allocation-hard-ceiling-bytes>";

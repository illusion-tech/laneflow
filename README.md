...
- `crates/laneflow-bevy`：Bevy 0.19 Reference Adapter；使用最小 modular dependency graph，提供单活动 `LaneFlowSession`、宿主 outer-frame 驱动的专用 fixed schedule、可配置 catch-up 和完整 backlog 保留。

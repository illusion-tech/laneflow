...
- `crates/laneflow-data`：当前 Traffic v0.8 JSON loader、严格版本闸口、Junction/Movement/ManeuverPath/ManeuverGate、per-edge `speedLimit` 与 Core normalization；依赖方向固定为 `laneflow-data -> laneflow-core`。

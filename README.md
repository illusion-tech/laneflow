...
效果。#291 正在修订编译器拥有的静态路网与目标静态镜像设计；在 #291 G1 接受前，
它只是 Proposed 目标提案。在阶段 8 生产切换 Issue #294 完成 G4 前，当前
JSON/Data/Core/Spatial 路径仍是生产契约。

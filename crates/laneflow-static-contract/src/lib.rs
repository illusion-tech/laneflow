...
pub use typed::{
    ...
    ParticipantStreamId, ParticipantStreamKind, ParticipantStreamOrdinal, RoadCorridorId,
    RoadCorridorKind, RoadCorridorOrdinal, RoadSectionId, RoadSectionKind, RoadSectionOrdinal,
    SignalControllerId, SignalControllerKind, SignalControllerOrdinal, SignalGroupId,
    SignalGroupKind, SignalGroupOrdinal, SignalPhaseId, SignalPhaseKind, SignalPhaseOrdinal,
    StableId, StableId128, StableIdTextError, StopLineId, StopLineKind, StopLineOrdinal,
    VehicleProfileId, VehicleProfileKind, VehicleProfileOrdinal, WaitingZoneId, WaitingZoneKind,
    WaitingZoneOrdinal,
};
pub use values::{

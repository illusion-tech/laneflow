...
pub use portable::{
    ...
    CONSTRAINT_CONTRACT_VERSION, ExactByteLength, FORMAT_HARD_MAX_CANDIDATE_STAGING_BYTES,
    FORMAT_HARD_MAX_FIELDS_PER_ROW, FORMAT_HARD_MAX_IDENTITY_ASCII_BYTES,
    FORMAT_HARD_MAX_OBJECT_BYTES, FORMAT_HARD_MAX_RECORD_VECTOR_DEPTH,
    FORMAT_HARD_MAX_ROWS_PER_TABLE, FORMAT_HARD_MAX_SECTION_OR_TABLE_BYTES,
    FORMAT_HARD_MAX_SOURCE_LOCATION_ROWS, FORMAT_HARD_MAX_TOTAL_UTF8_BYTES,
    FORMAT_HARD_MAX_TOTAL_VECTOR_BYTES, FORMAT_HARD_MAX_UTF8_FIELD_BYTES,
    FORMAT_HARD_MAX_VECTOR_ITEMS, NETWORK_REVISION_DERIVATION_VERSION,
    NETWORK_REVISION_DOMAIN_PREFIX, NetworkRevisionId, OBJECT_PREAMBLE_BYTE_LENGTH,
    PortableFieldType, PortableObjectKind, SECTION_DIRECTORY_ENTRY_BYTE_LENGTH,
    SECTION_FORMAT_VERSION, SEMANTIC_DIFF_FORMAT_VERSION, SOURCE_MAP_FORMAT_VERSION,
    STATIC_EXECUTION_CONTRACT_VERSION, Sha256Digest,
};
...
pub use values::{
    ...
    MIN_LANE_EDGE_LENGTH_MM, MIN_PARKING_EXTENT_EXCLUSIVE_METERS,
    MIN_PARKING_LATERAL_OFFSET_ABS_EXCLUSIVE_METERS, MIN_PARKING_LATERAL_OFFSET_ABS_MM,
    MIN_SPEED_MM_S, MIN_VEHICLE_LENGTH_EXCLUSIVE_METERS, MIN_VEHICLE_LENGTH_MM,
    PARKING_ANCHOR_ENDPOINT_CLEARANCE_METERS, PARKING_ANCHOR_ENDPOINT_CLEARANCE_MM,

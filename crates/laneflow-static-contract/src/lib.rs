...
pub use portable::{
    ...
    CONSTRAINT_CONTRACT_VERSION_V1, ExactByteLength, FORMAT_HARD_MAX_CANDIDATE_STAGING_BYTES,
    ...
    NETWORK_REVISION_DOMAIN_PREFIX, NetworkRevisionId, OBJECT_PREAMBLE_V1_BYTE_LENGTH,
    PortableFieldType, PortableObjectKind, SECTION_DIRECTORY_ENTRY_V1_BYTE_LENGTH,
    SECTION_FORMAT_VERSION_V1, SEMANTIC_DIFF_FORMAT_VERSION, SOURCE_MAP_FORMAT_VERSION,
    STATIC_EXECUTION_CONTRACT_VERSION_V1, Sha256Digest,
};

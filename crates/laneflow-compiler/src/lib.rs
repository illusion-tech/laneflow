...
pub use compiler::{
    ...
    CanonicalManeuverOccurrenceView, CanonicalManeuverPathView, CanonicalMovementView,
    CanonicalParkingAreaView, CanonicalParkingLaneAnchor, CanonicalParkingSpaceGeometry,
    CanonicalParkingSpaceView, CanonicalParticipantClassView, CanonicalPoint3F32,
    ...
    CanonicalSignalPhaseView, CanonicalSpatialSegment, CanonicalStaticRouteOccurrenceRef,
    CanonicalStaticRouteView, CanonicalStopLineView, CanonicalVehicleProfileView,
    CanonicalWaitingZoneOccurrenceView, CanonicalWaitingZoneView, CompilationMetrics,
...
pub use diagnostic::{
    ...
    ParkingGeometryViolation, RoadEditingInputViolation, RoadEditingSourceViolation,

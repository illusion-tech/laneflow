...
pub use compiler::{
    ...
    CanonicalFrameView, CanonicalGateOccurrenceView, CanonicalIdentityFieldView,
    CanonicalJunctionInternalEdgeView, CanonicalJunctionView, CanonicalLaneEdgeView,
    CanonicalLaneGroupView, CanonicalManeuverGateView, CanonicalManeuverOccurrenceView,
    ...
    CanonicalParticipantClassView, CanonicalRoadCorridorView, CanonicalRoadSectionView,
    ...
    CanonicalStaticRouteView, CanonicalStopLineView, CanonicalVehicleProfileView,
...
pub use declaration::{
    ...
    CanonicalFrameInput, CorridorElementReference, EntityReference, FacilityBandInput,
    FacilityBandReference, FacilityKindCategory, FacilityKindViolation, IidmVehicleProfileInput,
    JunctionInput, JunctionReference, LaneEdgeInput, LaneEdgeReference, LaneGroupInput,
    ...
    RoadSectionReference, ScalarViolation, SignalControlInput, SignalControllerInput,
    SignalGroupInput, SignalGroupReference, SignalGroupStateInput, SignalPhaseInput,
    StaticRouteInput, StopLineInput, StopLineReference, VehicleProfileInput,

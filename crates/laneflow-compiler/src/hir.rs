...
use crate::declaration::{
    CanonicalPoint3F32Input, LaneEdgeDeclaration, LaneEdgeGeometryAuthority, OwnedAccessRegulation,
...
mod tests {
    use super::*;
    use crate::{
        CanonicalFrameInput, CompilationUnitBuilder, CompileLimits, DiagnosticCode,
        DiagnosticPayload, GeometryAccuracyProfile, GeometryDirectionProfile, JunctionInput,
        JunctionReference, LaneEdgeInput, LaneEdgeReference, ManeuverGateInput, ManeuverPathInput,
        ManeuverPathReference, MovementInput, MovementReference, SignalControlInput,
        SourceModuleHeader, SourceModuleHeaderInput, SourceSpan, StopLineInput, StopLineReference,

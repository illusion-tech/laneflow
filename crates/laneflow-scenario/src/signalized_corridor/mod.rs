...
pub use catalog::{
    AUTHORING_NAMESPACE, CATALOG_VERSION, CatalogError, CatalogPolicySelection, CorridorCatalog,
    MIN_SPAWN_SLOT_COUNT, PASSENGER_CAR_PROFILE_KEY, PORTAL_IDS, PROTECTED_ENTRY_POLICY_KEY,
    PortalCatalogEntry, PortalLaneCatalogEntry, ROUTE_COUNT, RouteCatalogEntry,
    SHUTTLE_BUS_PROFILE_KEY, SpawnSlotCatalogEntry, WeightedRouteChoiceCatalogEntry, validate,
};
pub use population::{

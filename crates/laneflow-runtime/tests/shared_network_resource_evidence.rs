...
const CORRIDOR_SHA256: [u8; 32] = [
    0x20, 0x42, 0x34, 0xe2, 0xb2, 0x9f, 0xc9, 0x0d, 0xe5, 0xc5, 0x33, 0x17, 0xf2, 0xe0, 0xc5, 0xff,
    0xa4, 0x3d, 0x38, 0x85, 0xf3, 0x34, 0x0a, 0x53, 0x5c, 0x56, 0x4c, 0xc5, 0x86, 0x34, 0x54, 0x69,
];
...
fn wall_clock_build_identity_and_kernel() {
    ...
    for (scene, bytes, spatial) in [
        ...
        let build_ns = measure_ns_held(WARMUP, SAMPLES, || build(bytes, spatial));
        println!(

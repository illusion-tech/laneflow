...
mod retained_memory {
    ...
    impl RouteSlot {
        fn retained_stats(&self) -> RouteSlotRetainedStats {
            ...
            let total_bytes = external_id.capacity()
                ...
                + speed_limit_transitions.capacity()
    ...
    impl CoreWorld {
        pub(super) fn lifecycle_retained_stats(&self) -> LifecycleRetainedStats {
            ...
            let lifecycle_scratch_bytes =
                free_list_bytes + vehicle_order_bytes + candidate_state_bytes;
            ...
            LifecycleRetainedStats {
                ...
                participant_class_registry_bytes: complete_components
                    .participant_class_registry_bytes,

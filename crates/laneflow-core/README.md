...
- `CoreError`：表达 fixed delta、tick delta mismatch、时间溢出、lane graph / route / Signals / Parking / vehicle 静态校验、道路限速、物理重叠、leader / longitudinal 非有限计算、stale handle、route lifecycle 和数值校验错误；
